...
public class LibraryApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			User user1 = new User("adminC", pwEncoder.encode("test"), "Kabdani.Centre@emsi.com", "Kabdani", "Med", "Centre 158", "06-000000", "CASA");
			user1.setRole("ROLE_ADMIN");
			
			User user2 = new User("employee", pwEncoder.encode("test"), "Kabdani.Centre@emsi.com", "Kabdani", "Med", "Centre 158", "06-000000", "CASA");
